...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('dashboard.detail.update', $pegawai) }}">
                @csrf
                @method ('PUT')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="nip" type="text" class="form-control @error ('kode_golongan') is-invalid @enderror" name="nama" value="{{ $pegawai->nama }}" required>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="nip" type="text" class="form-control @error ('kode_golongan') is-invalid @enderror" value="{{ $pegawai->golongan->nama_golongan }}" readonly required>
